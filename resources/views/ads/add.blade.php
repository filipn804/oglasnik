                    ...
                    <div class="grid grid-cols-3 gap-6">
                        ...
                        <div class="col-span-3 sm:col-span-2">
                         ...
                         <div class="col-span-3 sm:col-span-2">
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                <input type="text" name="price" value="{{old('price')}}" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300 @error('title') border-red-500 @enderror" placeholder="Title">
                            </div>
                            @error('price')
                            <div class="text-red-600">{{$message}}</div>
                            @enderror
